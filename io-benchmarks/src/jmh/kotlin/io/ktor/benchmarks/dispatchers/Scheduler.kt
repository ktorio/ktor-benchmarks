...
internal class HighThroughputScheduler(
    @JvmField val corePoolSize: Int,
    @JvmField val maxPoolSize: Int,
    @JvmField val idleWorkerKeepAliveNs: Long = IDLE_WORKER_KEEP_ALIVE_NS,
    @JvmField val schedulerName: String = "Ktor scheduler"
) : Executor, Closeable {
    init {
    ...
    internal inner class Worker private constructor() : Thread() {
        ...
        inline val scheduler get() = this@HighThroughputScheduler
        ...
        private fun tryAcquireCpuPermit(): Boolean = when {
            ...
            this@HighThroughputScheduler.tryAcquireCpuPermit() -> {
            ...
            repeat(created) {
                ...
                if (worker !== null && worker !== this) {
                    ...
                    if (stealResult == TASK_STOLEN) {
                        ...
                        minDelay = minOf(minDelay, stealResult)
                    }
                }
            }
...
internal fun isSchedulerWorker(thread: Thread) = thread is HighThroughputScheduler.Worker
...
@Suppress("UNUSED")
@JvmName("mayNotBlock")
internal fun mayNotBlock(thread: Thread) = thread is HighThroughputScheduler.Worker &&
        thread.state == HighThroughputScheduler.WorkerState.CPU_ACQUIRED
