...
internal class ExperimentalPC<TSubject : Any, TContext : Any>(
    initial: TSubject,
    override val context: TContext,
    private val blocks: List<PipelineInterceptor<TSubject, TContext>>
) : PipelineContext<TSubject, TContext>, PipelineExecutor<TSubject>,
    CoroutineScope {
    ...
    private fun loop(direct: Boolean): Boolean {
        do {
            ...
            try {
                val result = next.startCoroutineUninterceptedOrReturn3(this, subject, continuation)
